...
import { Image, Text, SafeAreaView, ScrollView, View, TextInput, Switch} from "react-native";
        ...
        <SafeAreaView style={{ backgroundColor: 'white', flex: 1}}>
           ...
           >
            ...
            <TouchableOpacity onPress={()=>{
                ...
                <Ionicons name="close" size={30} style={{marginTop:30}} color="orange" style={styles.editIcon}/>
            </TouchableOpacity>
                        <TextInput
